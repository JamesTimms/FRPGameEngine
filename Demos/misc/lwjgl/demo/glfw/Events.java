 ...
 */
package misc.lwjgl.demo.glfw;

import misc.lwjgl.demo.util.ClosureGC;
import misc.lwjgl.demo.util.IOUtil;
...
import static misc.lwjgl.demo.util.IOUtil.ioImageResourceToByteBuffer;
...
public final class Events {
	...
	public static void main(String[] args) {
		System.setProperty(
			"org.misc.lwjgl.system.libffi.ClosureRegistry",
			"org.misc.lwjgl.demo.util.ClosureGC"
		);
	...
	private static void demo() {
		...
		if ( LWJGLUtil.getPlatform() != Platform.MACOSX ) {
			try {
				IOUtil.ImageData pixels = ioImageResourceToByteBuffer("demo/cursor.png");

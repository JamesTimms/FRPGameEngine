...
import misc.lwjgl.demo.util.Camera;
import misc.lwjgl.demo.util.Matrix4f;
...
import static misc.lwjgl.demo.util.IOUtil.ioResourceToByteBuffer;
...
public class HybridDemo {
	...
	static {
		 ...
		 */
		System.setProperty("org.misc.lwjgl.opengl.maxVersion", "4.3");
	}
	 ...
	 * given corner coordinates into the provided {@link java.nio.FloatBuffer}.
	 *
	 * @param min
	 *            the min corner
	 * @param max
	 *            the max corner
	 * @param fv
	 *            the {@link java.nio.FloatBuffer} receiving the vertex position and
	 *            normal
	 */
